...
from src.views.selection_sort.static_ui import UiSelectionSort
from src.models.selection_sort import SelectionSortModel

ViewWidget = TypeVar('ViewWidget', bound=QWidget)


class SelectionSortView(QWidget, DObserver, metaclass=TSMeta):
    id: str = "selection_sort"

    def __init__(self, controller, model: SelectionSortModel, widgets_factory, parent: ViewWidget):
