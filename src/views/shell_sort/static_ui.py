...
class UiShellSort:
    def setup_ui(self, shell_sort: QtWidgets.QWidget, theme_class, widgets_factory: WidgetsFactory):
        shell_sort.setObjectName("shell_sort")
        shell_sort_layout = QtWidgets.QVBoxLayout(shell_sort)
        shell_sort_layout.setContentsMargins(0, 0, 0, 0)
        shell_sort_layout.setSpacing(0)

        customize_sheet = QtWidgets.QWidget(shell_sort)
        ...
        shell_sort_layout.addWidget(customize_sheet)
        ...
        #
        # ch_theme_header = widgets_factory.heading3(parent=shell_sort)
        ...
        #
        # ch_color_theme_widget = widgets_factory.combo_box(parent=shell_sort)
        ...
        self.translate_ui(shell_sort)
        QtCore.QMetaObject.connectSlotsByName(shell_sort)

    def translate_ui(self, shell_sort: QtWidgets.QWidget):
