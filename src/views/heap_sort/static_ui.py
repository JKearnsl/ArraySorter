...
class UiHeapSort:
    def setup_ui(self, heap_sort: QtWidgets.QWidget, theme_class, widgets_factory: WidgetsFactory):
        heap_sort.setObjectName("heap_sort")
        heap_sort_layout = QtWidgets.QVBoxLayout(heap_sort)
        heap_sort_layout.setContentsMargins(0, 0, 0, 0)
        heap_sort_layout.setSpacing(0)

        customize_sheet = QtWidgets.QWidget(heap_sort)
        ...
        heap_sort_layout.addWidget(customize_sheet)
        ...
        #
        # ch_theme_header = widgets_factory.heading3(parent=heap_sort)
        ...
        #
        # ch_color_theme_widget = widgets_factory.combo_box(parent=heap_sort)
        ...
        self.translate_ui(heap_sort)
        QtCore.QMetaObject.connectSlotsByName(heap_sort)

    def translate_ui(self, heap_sort: QtWidgets.QWidget):
